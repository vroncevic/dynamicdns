...
Copyright
    ...
    dynamicdns is distributed in the hope that it will be useful, but
...
project: str = 'dynamicdns'
project_copyright: str = '2026, Vladimir Roncevic <elektron.ronca@gmail.com>'
author: str = 'Vladimir Roncevic <elektron.ronca@gmail.com>'
version: str = '3.0'
release: str = 'https://github.com/vroncevic/dynamicdns/releases'
...
htmlhelp_basename: str = 'dynamicdnsdoc'
latex_elements: Dict[Any, Any] = {}
latex_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'dynamicdns.tex', 'dynamicdns Documentation',
    'Vladimir Roncevic \\textless{}elektron.ronca@gmail.com\\textgreater{}',
    'manual'
)]
man_pages: List[Tuple[Any, ...]] = [(
    master_doc, 'dynamicdns', 'dynamicdns Documentation', [author], 1
)]
texinfo_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'dynamicdns', 'dynamicdns Documentation', author, 'dynamicdns',
