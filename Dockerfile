...
RUN mkdir -p /root/scripts/dynamicdns/ver.3.0/
RUN mkdir /root/bin/
RUN cp -R /sh_tool/bin/   /root/scripts/dynamicdns/ver.3.0/
RUN cp -R /sh_tool/conf/  /root/scripts/dynamicdns/ver.3.0/
RUN cp -R /sh_tool/log/   /root/scripts/dynamicdns/ver.3.0/
RUN rm -Rf /sh_tool/
RUN chmod -R 755 /root/scripts/dynamicdns/ver.3.0/
RUN ln -s /root/scripts/dynamicdns/ver.3.0/bin/dynamicdns.sh /root/bin/dynamicdns
RUN tree /root/scripts/dynamicdns/ver.3.0/
